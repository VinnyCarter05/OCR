...
class Ui_MainWindowOCR(object):
    def setupUi(self, MainWindowOCR):
        ...
        self.pushButton_Discard = QtWidgets.QPushButton(self.frame_2)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/newPrefix/icons/bold.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/newPrefix/icons/italic.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/newPrefix/icons/underline.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, MainWindowOCR):
        ...
        self.pushButton_Discard.setText(_translate("MainWindowOCR", "Discard"))
