...
class Ui_MainWindowOCR(object):
    def setupUi(self, MainWindowOCR):
        ...
        MainWindowOCR.setWindowIcon(icon)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/newPrefix/icons/Fatcow-Farm-Fresh-Arrow-rotate-anticlockwise.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_CCW.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/newPrefix/icons/Fatcow-Farm-Fresh-Arrow-rotate-clockwise.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_CW.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/newPrefix/icons/preview.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_OCR.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/newPrefix/icons/Saki-NuoveXT-Actions-arrow-left-end.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_FirstPage.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/newPrefix/icons/Saki-NuoveXT-Actions-arrow-left.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_PrevPage.setIcon(icon5)
        ...
        self.label_totalPages = QtWidgets.QLabel(self.frame_3)
        self.label_totalPages.setObjectName("label_totalPages")
        self.horizontalLayout_3.addWidget(self.label_totalPages)
        self.pushButton_NextPage = QtWidgets.QPushButton(self.frame_3)
        self.pushButton_NextPage.setText("")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/newPrefix/icons/Saki-NuoveXT-Actions-arrow-right.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_NextPage.setIcon(icon6)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/newPrefix/icons/Saki-NuoveXT-Actions-arrow-right-end.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_LastPage.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/newPrefix/icons/Saki-NuoveXT-2-Folder-open.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionOpen_File.setIcon(icon8)
        self.actionOpen_File.setObjectName("actionOpen_File")
        self.action_Save = QtWidgets.QAction(MainWindowOCR)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/newPrefix/icons/Saki-NuoveXT-2-Actions-document-save.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Save.setIcon(icon9)
        self.action_Save.setObjectName("action_Save")
        self.actionSave_As = QtWidgets.QAction(MainWindowOCR)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/newPrefix/icons/Saki-NuoveXT-2-Actions-document-save-as.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionSave_As.setIcon(icon10)
        self.actionSave_As.setObjectName("actionSave_As")
        self.actionQuit = QtWidgets.QAction(MainWindowOCR)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/newPrefix/icons/close.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionQuit.setIcon(icon11)
        self.actionQuit.setObjectName("actionQuit")
        self.actionCut = QtWidgets.QAction(MainWindowOCR)
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/newPrefix/icons/Saki-NuoveXT-2-Actions-cut.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCut.setIcon(icon12)
        self.actionCut.setObjectName("actionCut")
        self.actionCopy = QtWidgets.QAction(MainWindowOCR)
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/newPrefix/icons/Saki-NuoveXT-2-Actions-edit-copy.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCopy.setIcon(icon13)
        self.actionCopy.setObjectName("actionCopy")
        self.actionPaste = QtWidgets.QAction(MainWindowOCR)
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/newPrefix/icons/Saki-NuoveXT-2-Actions-clipboard.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionPaste.setIcon(icon14)
        self.actionPaste.setObjectName("actionPaste")
        self.actionOCR_Page = QtWidgets.QAction(MainWindowOCR)
        self.actionOCR_Page.setIcon(icon3)
        self.actionOCR_Page.setObjectName("actionOCR_Page")
        self.actionUndo = QtWidgets.QAction(MainWindowOCR)
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/newPrefix/icons/Saki-NuoveXT-2-Actions-blue-arrow-undo.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionUndo.setIcon(icon15)
        self.actionUndo.setObjectName("actionUndo")
        self.actionRedo = QtWidgets.QAction(MainWindowOCR)
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/newPrefix/icons/Saki-NuoveXT-2-Actions-blue-arrow-redo.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRedo.setIcon(icon16)
        self.actionRedo.setObjectName("actionRedo")
        self.actionBold = QtWidgets.QAction(MainWindowOCR)
        self.actionBold.setCheckable(True)
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/newPrefix/icons/Saki-NuoveXT-2-Actions-format-text-bold.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionBold.setIcon(icon17)
        self.actionBold.setObjectName("actionBold")
        self.actionItalic = QtWidgets.QAction(MainWindowOCR)
        self.actionItalic.setCheckable(True)
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(":/newPrefix/icons/Saki-NuoveXT-2-Actions-format-text-italic.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionItalic.setIcon(icon18)
        self.actionItalic.setObjectName("actionItalic")
        self.actionUnderline = QtWidgets.QAction(MainWindowOCR)
        self.actionUnderline.setCheckable(True)
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap(":/newPrefix/icons/Saki-NuoveXT-2-Actions-format-text-underline.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.actionCCW90.setIcon(icon1)
    ...
    def retranslateUi(self, MainWindowOCR):
        ...
        MainWindowOCR.setWindowTitle(_translate("MainWindowOCR", "MFMC OCR"))
        ...
        self.label_totalPages.setText(_translate("MainWindowOCR", "of 1"))
